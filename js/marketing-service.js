/* marketing-service.js — reads slug from URL, fetches matching marketing service, renders detail page */

async function initMarketingService() {
  try {
    ...
    const res      = await fetch('/data/marketing-services.json');
    ...
    document.title = `${service.title} — Simmico Marketing`;
    renderServiceDetail(service);
  } catch (e) {
    console.error('marketing-service.js:', e);
  }
}
  ...
  el.innerHTML = `
    <div class="service-detail-hero">
      <div class="service-detail-badge">
        ...
        <span class="service-detail-badge-label">Marketing</span>
      </div>
    ...
    <div class="detail-cta-section">
      <div class="cta-block">
        ...
        <div class="cta-block-body">Tell us what you need and we'll come back with a clear approach.</div>
...
document.addEventListener('DOMContentLoaded', initMarketingService);
